...
class Ball:
    ...
    def collide(self, other_ball):
        ...
        distance_squared = (other_ball_pos[0] - self._pos[0]) ** 2 + (other_ball_pos[1] - self._pos[1]) ** 2
    ...
    def bounce(self, other_ball):
        ...
        # Compute tangential components of velocities for both balls
...
plot_performance(100, RATIO_PLOT)
